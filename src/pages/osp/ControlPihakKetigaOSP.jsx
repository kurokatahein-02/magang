...
const API_URL = "http://127.0.0.1:8000/api/third-parties";
...
const ControlPihakKetigaOSP = () => {
  ...
  const handleDownload = async (item, e) => {
    ...
    try {
      ...
      alert(
        "Gagal mengunduh dokumen. Pastikan Anda memiliki koneksi internet dan file tersedia di server.",
      );
    }
  };
                  ...
                  (v) =>
                    ...
                    v.lng && (
                      <Marker key={v.id} position={[v.lat, v.lng]}>
                        ...
                        {/* Tambahkan Tooltip Permanen di bawah ini */}
                        <Tooltip
                          permanent
                          direction="top"
                          offset={[0, -10]}
...
export default ControlPihakKetigaOSP;
