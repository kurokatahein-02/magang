...
const DashboardASO = () => {
            ...
            <div className="mb-6 flex items-center gap-4">
              ...
              <div>
                <h4 className="font-bold text-lg uppercase">
                  Daftar Kegiatan ASO Belum Close (Tunggakan)
                </h4>
                <p className="text-xs text-gray-500 italic">
                  * Menampilkan kegiatan ASO bulan-bulan sebelumnya yang belum diselesaikan.
                </p>
              </div>
            </div>
              ...
              <table className="w-full text-left border-collapse">
                ...
                <tbody>
                  {alertData.length > 0 ? (
                    ...
                    <tr>
                      <td colSpan="4" className="p-10 text-center text-gray-400 italic">Tidak ada tunggakan kegiatan ASO.</td>
                    </tr>
                  )}
                </tbody>
              </table>
  ...
  // Filter Alert khusus ASO
  const asoAlertCount = (data?.alerts?.kegiatan || []).filter(
    (item) => item.unit.toLowerCase() === "aso"
  ).length;
  ...
  return (
    <div className="h-full flex flex-col gap-6 select-none relative p-2 overflow-y-auto no-scrollbar pb-20">
      ...
      <div className="flex-1 grid grid-cols-12 gap-6 min-h-0">
        ...
        <div className="col-span-12 flex flex-col gap-6 h-full">
          <AlertBox
            title="Notifikasi Kegiatan Open"
            count={asoAlertCount}
            msg="ASO BELUM DISELESAIKAN"
            ...
            >
              ...
              <div className="mt-4 pt-2 border-t border-black/5 flex justify-between items-end">
                <div className="text-[9px] uppercase font-bold text-gray-400">
                  {ASOInventoryCount} Jenis Barang
                </div>
    ...
    <div className="space-y-1.5 flex-1 flex flex-col justify-center">
      {count > 0 ? (
        ...
        <div className="text-[10px] text-gray-400 italic text-center py-2">
          Tidak ada kegiatan ASO yang menunggak.
        </div>
      )}
    </div>
  </div>
