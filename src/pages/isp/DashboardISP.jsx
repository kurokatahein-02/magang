...
const DashboardISP = () => {
  ...
  const [ispInventoryCount, setIspInventoryCount] = useState(0); // State khusus hitung inventory ISP
  ...
  const fetchData = async () => {
    try {
      ...
      const responseInv = await axios.get(INVENTORY_API, {
        params: { unit: 'isp' } // <-- Parameter diatur ke 'isp'
      });
        ...
        <div className="col-span-5 flex flex-col gap-6 h-full">
          ...
          >
            ...
            <div className="flex-1 flex flex-col items-center justify-center">
              {/* DISINI MENGGUNAKAN STATE KHUSUS ISP YANG BARU */}
